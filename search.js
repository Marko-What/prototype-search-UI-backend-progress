...
/*	contentContainer = $('div#contentContainer.default').clone(true);*/
	...
	function noUser(){
		...
		function simpleRotate(){
					...
					setTimeout("$('input').removeClass('leftRot');", 450);
				}

		/*	confirm('user does not exist in a database...');*/
				$('div#NoUserBox').addClass('display');
				$('div#NoUserBox').animate({'left':'65%'}, 450, function(){
						$('div#NoUserBox').animate({'left':'25%'}, 350, function(){
							$('div#NoUserBox').animate({'left':'25%'}, 180);
							simpleRotate();
						});
				});
